...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20211120152012_init2")]
    partial class init2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Address", b =>
                {
                    ...
                    b.HasIndex("PsychologistId")
                        .IsUnique()
                        .HasFilter("[PsychologistId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.UserContact", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.Address", b =>
                {
                    b.HasOne("Domain.Entities.Psychologist", "Psychologist")
                        .WithOne("Address")
                        .HasForeignKey("Domain.Entities.Address", "PsychologistId");
            ...
            modelBuilder.Entity("Domain.Entities.Appointment", b =>
                {
                    b.HasOne("Infrastructure.Identity.User", "Client")
                        .WithMany("UserAppointments")
                        .HasForeignKey("ClientId");

                    b.HasOne("Infrastructure.Identity.User", "Psychologist")
